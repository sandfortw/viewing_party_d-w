...
RSpec.describe Party, type: :model do
  ...
  before do
    ...
    @user_5 = User.create!(name: 'Maggie', email: 'Maggie@springfield.com', password: 'password')
    @user_6 = User.create!(name: 'Bart', email: 'Bart@springfield.com', password: 'password')
    @user_7 = User.create!(name: 'Lisa', email: 'Lisa@springfield.com', password: 'password')
    @user_8 = User.create!(name: 'Krusty', email: 'Krusty@springfield.com', password: 'password')
    @user_9 = User.create!(name: 'Mr.Burns', email: 'CEO@springfield.com', password: 'password')
    @user_10 = User.create!(name: 'Lenny', email: 'Drunk@springfield.com', password: 'password')
